package day22_Arrays_Split;

import java.util.Arrays;

public class C02_Harf_KacKere_Kullanilmis {
    ...
    private static void harfKacKereKullanilmis(String cumle, char harf) {
        ...
        System.out.println("Aradiginiz harf :" + harf + "-dir ve verilen cumlede " + sayac + " kez kullanilmistir");
    }
}
